...
function Work() {
  return (
    <div className='relative h-screen mt-24 overflow-hidden flex items-center justify-evenly flex-col '>
      <h3 className=' uppercase absolute top-0 text-[#3F9D86] text-xl tracking-[10px] '>Experience</h3>
